...
@dag(
    ...
    schedule=None,
    start_date=pendulum.from_format("2024-05-01", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "Prashanth BS": "mailto:pbs@113industries.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clvm6ngbd0awx01lp6bulu78s/cloud-ide/clvnd9cxx00uq01o1luruttuf/clvnd9deo00sm01p9jkbfsud7",
    },
)
